      ...
      >
        ...
        <div className="flex-1 overflow-y-auto w-full custom-scrollbar flex flex-col justify-between">
          ...
          <nav className="px-3 py-4 flex flex-col gap-0.5 shrink-0">
            {menuItems.map((item) => {
              ...
              return (
                ...
                >
                  <IconComp
                    className={`w-4 h-4 transition-transform duration-250 ${isSelected ? "scale-110" : ""}`}
                  />
          ...
          <div className="p-3 bg-zinc-950 flex flex-col gap-3.5 border-t border-zinc-900/65 shrink-0 mt-auto">
            ...
            <div
              className="bg-zinc-900/40 border border-zinc-900 rounded-xl p-3 flex flex-col gap-1.5"
              id="portfolio-metric-sidebar-widget"
            >
              <div className="flex items-center justify-between">
                <span className="text-[9px] text-zinc-550 uppercase tracking-widest font-mono font-bold">
                  Portfolio
                </span>
              </div>
                  ...
                  <div className="flex items-center gap-2.5 p-2 border-b border-zinc-800/80 mb-1 shrink-0">
                    ...
                    <div className="flex flex-col min-w-0">
                      ...
                      <span className="text-[9px] text-zinc-500 font-mono tracking-tight font-bold flex items-center gap-1">
                        ...
                        <span>•</span>
                        <span className="text-zinc-400 font-extrabold uppercase tracking-widest scale-95">
                          {userStats.title}
                        </span>
                      </span>
                    </div>
                ...
                >
                  <div className="flex items-center gap-2.5 min-w-0">
                    ...
                    <div className="flex flex-col min-w-0">
                      ...
                      <span className="text-[10px] text-zinc-500 font-mono tracking-tight text-glow">
                        {userStats.handle}
                      </span>
                    </div>
                  </div>
                  <ChevronDown
                    className={`w-4 h-4 text-zinc-500 transition-transform duration-250 ${showDropdown ? "rotate-180" : ""}`}
                  />
                </div>
              )}
            </div>
